  ...
  <center>
    <table role="presentation" class="email-container">
      ...
      <tr>
        <td class="content">
          <h5>Hi {{ $user_name }},</h5>
          <p>Your token #{{ $apoinment_details->token_number }} for {{ $apoinment_details->appontmenter->appointmenter_name }} on {{ get_date($apoinment_details->booking_date) }} has been cancelled.</p>
