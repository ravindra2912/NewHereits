...
<div class="container mt-1 mb-4 ablack">
  <div class="row">
    ...
    <div class="col-lg-12 bg-white shadow-md rounded p-2 mb-2">
      ...
      <a href="{{ route('business.dashboard') }}" class="row pl-2 pr-2 pb-2" style="border-bottom: 1px solid rgba(0,0,0,.1);">
        <div class=" col-9 pl-4">
          <p class="text-2 font-weight-600 mb-0">Manage Business</p>
          <p class="text-1 mb-0">Manage Your Businesses</p>
        </div>
        <div class=" col-3 text-right" style="align-self: center;">
          <i class="fas fa-chevron-right"></i>
        </div>
