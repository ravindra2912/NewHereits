...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Edit Business Category</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card card-outline card-info">
        ...
        <!-- /.card-header -->
        <div class="card-body">
        <form action="{{ route('admin.businesscategory.update', $cat->id) }}" data-action="redirect" class="row formaction">
            @csrf
            ...
            <div class="col-md-12 row">
              <div class="col-md-4 " style="justify-items: center;">
                <div class="avtar">
                  <img src="{{ getImage($cat->image) }}" class="avtar_img" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="status">
                      ...
                      <option value="{{ $status }}" {{ $cat->status == $status ?'selected':'' }}>{{ $status }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
