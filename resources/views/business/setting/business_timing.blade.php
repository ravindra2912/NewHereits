...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Business Timing</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  ...
  <div class="modal fade" id="modal-timig">
    <div class="modal-dialog">
      <form action="{{ route('business.setting.business.timing.add') }}" id="timing-form" data-action="reload" class="modal-content formaction">
