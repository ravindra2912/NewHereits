...
@section('content')
@section('title', 'Professionals Page')
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Professionals list</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Professionals list</h3>
            <div class="float-right">
              <a href="{{ route('business.appointment.appointmenter.create') }}" class="btn btn-primary" title="Add"><i class="fas fa-plus"></i></a>
            </div>
          </div>
          <!-- /.card-header -->
...
<script type="text/javascript">
  $(function() {
    var table = $('#data-table').DataTable({
      processing: true,
      serverSide: true,
      ajax: "{{ route('business.appointment.appointmenter.index') }}",
      columns: [{
          data: 'image',
          name: 'image',
          orderable: false,
  ...
  function destroy(url, id) {
    Swal.fire({
        title: 'Are you sure?',
        icon: 'error',
        html: "You want to delete this Professional?",
