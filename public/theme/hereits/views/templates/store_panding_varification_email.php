                    ...
                    <table class="content-main-table" style="background: #ffffff;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td class="td-top-botom" align="left" style="border-bottom: 1px solid #e5e5e5; margin: 0 55px;">
                                ...
                                <p style="margin-top: 20px;font-size: 16px;font-weight: 400;word-break: keep-all;line-height: 1.4;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;">your store <b><?= $Store_name ?></b> is pending for approval.</p>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="margin-top: 20px;margin-bottom: 20px;display: inline-block;line-height: 22px;text-align: left;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> we have received your registration request. its take minimum 1-2 working day to approve your store request. since we will approve your request please set store timing, album and other details like store about us and terms and conditions of your store.</td>
                        </tr>
                                    ...
                                    <tr>
                                        <td style="font-size:13px; font-family: -apple-system,Helvetica,Arial,sans-serif; color:#787878;" class="td-top">
                                            <singleline>
												...
												sign up for Hereits account using in this email address, please ignore this message.
											</singleline>
                                        </td>
                                    </tr>
                                </table>
