            ...
            <tr>
                <td align="center" valign="top" style="padding:22px 0;background: #000000;border-top-left-radius: 10px;border-top-right-radius: 10px;" class="header-padding">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td align="center" valign="middle" class="logo-top-bottom"><a href="#"><img mc:edit="logo-main" src="<?= base_url() ?>assets/Logo/white-text-logo.png" width="100" alt=""></a></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <table class="content-main-table" style="background: #ffffff;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td class="td-top-botom" align="left" style="border-bottom: 1px solid #e5e5e5; margin: 0 55px; padding:22px 0;">
                                ...
                                <p style="font-size:14px;font-family: -apple-system,Helvetica,Arial,sans-serif;color: #33373d; line-height: 22px;margin-top: 20px;">You received order from <?= $username ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
						...
						<tr>
                            <td style="padding:0 15px; display:block; margin-top:20px;margin-bottom:20px;text-align:center;">
                                <a class="btn" style="background: #099e44; padding: 9px 25px; -webkit-border-radius: 2px; -moz-border-radius: 2px; -ms-border-radius: 2px; -o-border-radius: 2px; border-radius: 2px; font-family: Rubik; font-weight: normal; color: #ffffff; font-size: 16px;  font-weight: 500;  letter-spacing: .5px;  text-decoration: none;  display: inline-block;" href="<?= base_url() ?>Store_Order/Order_details/<?= $order_id ?>">
                                    View Order
                                </a>
                            </td>
                        </tr>
