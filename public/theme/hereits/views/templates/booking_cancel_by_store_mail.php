             ...
             <tr>
                <td>
                    <table class="content-main-table" style="background: #ffffff;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td class="td-top-botom" align="left" style="border-bottom: 1px solid #e5e5e5; margin: 0 55px; padding:22px 10px;">
                                <h5 style="margin: 0; font: bold 16px -apple-system,Helvetica,Arial,sans-serif;  color: #33373d; text-transform:uppercase;"> <strong style="text-transform: capitalize;">Hello,</strong> <?= $store_holder ?></h5>
                                <p style="font-size:14px;font-family: -apple-system,Helvetica,Arial,sans-serif;color: #33373d; line-height: 22px;margin-top: 20px;">your Booking is cancelled by <b><?= $username ?></b>. Because : <?= $cancel_reason ?>.
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <table style="margin-left: auto; margin-right: auto;">
									<tr style="text-align: center;background-color: #EEE;">
									 ...
									 <?php foreach($booking_item as $val){ ?>
									<tr style="text-align: center;">
										<td style="padding: 10px 0px 10px 0px;"><img src="<?= base_url().$val->packege_image ?>" height="60" width="60 />"</td> 
										<td style="padding: 10px 0px 10px 0px;"><?= $val->Package_name ?></td>
										<td style="padding: 10px 0px 10px 0px;"><?= $val->booking_qty ?> * <?= $val->item_amount ?></td>
									</tr>
									...
									<tr style="text-align: center;">
										<td style="background-color: #fff;"></td>
										<td style="background-color: #EEE; padding: 5px 0px 5px 0px; ">Inspection Charge </td>
										<td style="background-color: #EEE; padding: 5px 0px 5px 0px; ">Rs. <?= $inspection_charge ?></td>
									</tr>
									<tr style="text-align: center;">
										<td style="background-color: #fff;"></td>
									...
									<tr style="text-align: center;">
										...
										<td style="background-color: #EEE; padding: 5px 0px 5px 0px;">Rs. <?= $total - $coupon_amount + $inspection_charge ?></td>
									</tr>
								</table>
                            </td>
                        </tr>
						<tr>
                            <td style="padding:0 15px; display:block; margin-top:20px;margin-bottom:20px;text-align:center;">
                                <a class="btn" style="background: #099e44; padding: 9px 25px; -webkit-border-radius: 2px; -moz-border-radius: 2px; -ms-border-radius: 2px; -o-border-radius: 2px; border-radius: 2px; font-family: Rubik; font-weight: normal; color: #ffffff; font-size: 16px;  font-weight: 500;  letter-spacing: .5px;  text-decoration: none;  display: inline-block;" href="<?= base_url() ?>Store_Booking/Booking_details/<?= $booking_id ?>">
                                    View Booking
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-size:14px; font-family: -apple-system,Helvetica,Arial,sans-serif;color: #33373d;display: inline-block;line-height: 22px;">
                                kindly check it and confirm or reject Booking by clicking below link
                            </td>
                        </tr>
                        <tr>
                            <td class="link-div">
                                <a class="fpw" href="<?= base_url() ?>Store_Booking/Booking_details/<?= $booking_id ?>">
                                    <?= base_url() ?>Store_Booking/Booking_details/<?= $booking_id ?>
                                </a>
                            </td>
                        </tr>
                    </table>
