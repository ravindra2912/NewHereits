            ...
            <tr>
                <td>
                    <table class="content-main-table" style="background: #ffffff;" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        ...
                        <tr>
                            <td align="center" style="margin-top: 20px;display: inline-block;line-height: 22px;text-align: left;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> We received a request to reset the password associated with this e-mail address. If you made this request, please follow the instructions below. </td>
                        </tr>
                        
                        <tr>
                            <td align="center" style="display: inline-block;line-height: 22px;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> Click on the link below to reset your password using our secure server:</td>
                        </tr>
                        <tr>
                            <td align="center" style="font-size:16px; font-family: -apple-system,Helvetica,Arial,sans-serif; margin-top: 20px; margin-bottom: 30px; display: inline-block;text-align: left;"> <a class="main-links" href="<?= $url ?>Login"><?= $url ?></a></td>
                        </tr>
						<tr>
                            <td align="center" style="margin-top: 20px;display: inline-block;line-height: 22px;text-align: left;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> If you did not request to have your password reset you can safely ignore this email. Rest assured your account is safe.</td>
                        </tr>
						<tr>
                            <td align="center" style="margin-top: 20px;display: inline-block;line-height: 22px;text-align: left;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> If clicking the link does not seem to work, you can copy and paste the link into your browser's address window, or retype it there. Once you have returned to Hereits, we will give instructions for resetting your password.</td>
                        </tr>
						<tr>
                            <td align="center" style="margin-top: 20px;display: inline-block;line-height: 22px;text-align: left;font-size: 16px;font-weight: 400;word-break: keep-all;color: #33373d;font-family: -apple-system,Helvetica,Arial,sans-serif;"> Hereits will never e-mail you and ask you to disclose or verify your Hereits password, credit card, or banking account number. If you receive a suspicious e-mail with a link to update your account information, do not click on the link--instead, report the e-mail to Hereits for investigation. Greetings from Hereits.com</td>
                        </tr>
                    </table>
                </td>
            </tr>
