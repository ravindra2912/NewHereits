		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Package Listing</h3>
					<a href="<?php echo base_url(); ?>Package_management/Package_insert" class="btn btn-md btn-success" style="float: right;"><i class="fas fa-plus" style="font-size: 15px;"></i></a>
					</div>
					...
					<table id="Product_table" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th class="text-center">Package Sale-price</th>
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				url:'<?php echo base_url(); ?>Package_management/get_package_data/'+pagno,
				//method:"POST", 
				type: 'POST',
