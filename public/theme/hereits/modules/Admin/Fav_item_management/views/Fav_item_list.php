<div class="content-header m-hide">
    <div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Favourites</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Fav_item_management">Home</a></li>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Favourite Item </h3>
					</div>
			...
			<div class="card">
				<div class="card-body">
					<table id="Product_table" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="text-center">Favourite Id</th>
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				url:'<?php echo base_url(); ?>Fav_item_management/get_fav_item/'+pagno,
				//method:"POST", 
				type: 'POST',
