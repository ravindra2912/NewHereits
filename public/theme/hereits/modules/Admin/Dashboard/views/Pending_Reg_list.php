    ...
    <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <h3 class="card-title">Pending Registration Management</h3>               
            </div>
					...
					<table id="Product_table" class="table table-bordered table-striped">
						<thead>
							<tr>
							  ...
							  <th style="text-align: center;">Try at</th>
							</tr>
						</thead>
						<tbody>	
						</tbody>
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				url:'<?php echo base_url(); ?>Dashboard/get_pending_reg_data/'+pagno,
				//method:"POST", 
				type: 'POST',
				data:{ search:search},
				dataType: 'json',
				...
				{  
					//alert(response); 
					$('#Product_table tbody').html(response.result);
