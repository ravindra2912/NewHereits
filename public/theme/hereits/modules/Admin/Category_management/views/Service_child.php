        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Service Child Category List</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog modal-xl">
		  ...
		  <form id="update" method="POST" enctype="multipart/form-data" >
            <div class="modal-header">
              <h4 class="modal-title">Update Service Child Category</h4>
	...
	<div class="modal fade" id="add_model" >
        <div class="modal-dialog modal-xl">
		  ...
		  <form id="insert" method="POST" enctype="multipart/form-data" >
            ...
            <div class="modal-header">
              <h4 class="modal-title">Add Service Child Category</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				...
				//method:"POST", 
				type: 'POST',
				data:{ search:search, status:status, parent_category:parent_category, category_type:2 }, 
				dataType: 'json',
		...
		rules:{
			...
			category_name:{
				...
				remote:{
                    ...
                    type:'post',
                    data:{category_name:function(){ return $("#category_name").val(); },category_type:2}
				}
			},
		...
		rules:{
			...
			category_name:{
				...
				remote:{
                    url:'<?php echo base_url(); ?>Category_management/child_category_exists',
                    type:'post',
                    data:{category_name:function(){ return $("#update_category_name").val(); },category_id:function(){ return $("#update_id").val(); },category_type:2}
				}
			},
			category_status:{
				required:true,
