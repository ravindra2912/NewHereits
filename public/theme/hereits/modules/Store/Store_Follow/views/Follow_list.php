		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Followers Listing</h3>
					</div>
			...
			<div class="card">
				<div class="card-body">
					<table id="Product_table" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th class="text-center" colspan="2">Followers</th>
								<!--<th class="text-center">Follower Name</th>-->
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				url:'<?php echo base_url(); ?>Store_Follow/get_Follow_list/'+pagno,
				//method:"POST", 
				type: 'POST',
				data:{}, 
				dataType: 'json',
