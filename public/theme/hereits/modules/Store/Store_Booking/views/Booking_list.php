		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a class="onclick-load" href="<?php echo base_url(); ?>Store_dashboard">Home</a></li>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Booking Listing</h3>
					</div>
...
<script>
	...
	function get_data(pagno){
		...
		$.ajax({
				url:'<?php echo base_url(); ?>Store_Booking/get_Bokking_data/'+pagno,
				//method:"POST", 
				type: 'POST',
