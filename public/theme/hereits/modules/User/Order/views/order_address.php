			...
			<div class="row ">
				<div class="col-lg-12 p-4">
					<div class="row">
						...
						<form id="form" action="<?= base_url() ?>Order/update_address" method="post" class="col-lg-10 col-12 bg-white pt-3 mt-3">
							<h2 id="reviews" class="text-6">Delivery</h2>
							<hr class="mx-n3">
								
							<div class="form-group">
								<label for="note">Order Note</label>
								<input type="text" class="form-control" id="note" name="note" value="<?= $user_cart->note ?>" placeholder="Order Note">
							</div>
								
							<div class="mb-3">
								
								<label for="fullName">Delivery Type : </label>
								<div class="custom-control custom-radio custom-control-inline" style="position: unset;">
								  ...
								  <label class="custom-control-label" for="Pickup">Pickup At Store</label>
								</div>
								<?php if($user_cart->delivery_to_address == 1){ ?>
									<div class="custom-control custom-radio custom-control-inline" style="position: unset;">
										<input id="Deliverys" name="delivery_type" value="2" class="custom-control-input" required="" type="radio">
										<label class="custom-control-label" for="Deliverys">Delivery</label>
									</div>
								<?php 	} ?>
							...
							<div id="pickup-at-stores" style="display: none;">
								...
								<div class="mb-3">
									<label for="fullName">Pickup By : </label>
