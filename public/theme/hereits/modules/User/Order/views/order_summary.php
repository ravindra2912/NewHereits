			...
			<div class="row ">
				<div class="col-lg-8 p-4">
					<div class="row">
						...
						<div class="col-lg-12 bg-white pt-3 mt-3">
							<h2 id="reviews" class="text-6">Order Note</h2>
							<hr class="mx-n3">
							<p id="note">	
							</p>	
				...
				<div class="col-lg-4 bg-white mt-3 pt-3">
					...
					<div class="bg-white rounded p-3"> 
						...
						<a class="btn btn-primary btn-block mt-3" href="<?= base_url() ?>Order/place_to_order">Place Order</a>
					</div>
...
<script>
	...
	function remove_coupon(){
			...
			$.ajax({
				url:url + 'Order/remove_coupon_in_cart',
				method:"POST", 
				data:{ coupon_code:'' }, 
				//dataType: 'json',
				beforeSend:function(response)
