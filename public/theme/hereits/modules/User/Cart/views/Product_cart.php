				...
				<div class="col-lg-8 p-4">
					<div class="row">
						...
						<div class="col-lg-12 bg-white pt-3">
							<h2 id="reviews" class="text-6">Order Items</h2>
				...
				<div class="col-lg-4 bg-white mt-3 pt-3">
					...
					<div class="bg-white rounded p-3"> 
						<ul class="list-unstyled">
							...
							<!-- li class="mb-2">Shipping <span class="float-right text-4 font-weight-500 text-dark" id="Shipping">Rs.0</span></li>
						...
						<a class="btn btn-primary btn-block mt-3" href="<?= base_url() ?>Order" >Place Order</a>
					</div>
...
$("input[name='delivery_type']").change(function(){
  alert(this.value);
	...
	function update_qty(type, cart_item_id){
		$.ajax({
				url:url + 'Cart/update_cart_qty',
				method:"POST", 
				data:{ type:type, cart_item_id:cart_item_id }, 
				//dataType: 'json',
